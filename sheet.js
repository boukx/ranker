const bracket_data = [
  [1, 0, 1, , , , 0],
  [2, 2000, 1, , 180000, "=MIN(F1 + MAX(((E2/$C$16)*65000-F1)*INDEX($C$1:$C$14,MIN(MAX(1,G1),14)), 0),INDEX($B$1:$B$14,MIN(G1+4,14)))", "=MAX(IF(F2 >= 5000, MIN(INT(F2/5000) + 2, 14), IF(F2 >=2000, 2, 1)), G1)"],
  [3, 5000, 1, , 690000],
  [4, 10000, .8, , 750000],
  [5, 15000, .8, , 750000],
  [6, 20000, .8, , 750000],
